...
Diseña una clase "Animal" que herede sus propiedades y métodos a las clases "Perro y Ave" y luego que una de estas dos haga lo mismo pero con la clase "Monstruo".
#### 6.2 Código:
```dart
class Animal {
  String _especie = "";
