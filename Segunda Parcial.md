...
Diseña una clase "Animal" que herede sus propiedades y métodos a las clases "Perro y Ave", luego hacer lo mismo con una de estas dos pero con la clase "Monstruo".
#### 6.2 Código:
```dart
class Animal {
  String _especie = "";
